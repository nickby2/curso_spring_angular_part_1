...
import com.aplicacao.cursomc.repositories.ItemPedidoRepository;
...
public class CursemcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception{
		...
		Pedido ped2 = new Pedido(null, sdf.parse("30/10/2017 10:32"), cli1, end2);
		...
		ItemPedido ip3 = new ItemPedido(ped1, p2, 0.00, 1, 2000.00);
